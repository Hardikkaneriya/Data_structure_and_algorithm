...
# same hash location. so it will overwrite the value of old key with the value of new key.
# Hence it will return incorrect result of the key. In that case we need to handle collision problem
